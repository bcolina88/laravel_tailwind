                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border-t-0 px-6 align-center border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                            ...
                            <div class="flex item-center justify-center">
                                ...
                                <button wire:click="confirmItemEdit({{$user->id}})"
                                ...
                                <button wire:click="confirmItemDeletion({{$user->id}})"
                                    class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100 ">
                        <td colspan="6" class="py-3 px-12 whitespace-nowrap align-middle text-center">
                            <span class="font-medium ">No hay usuarios que mostrar.</span>
                        </td>
                    </tr>
